class t extends HTMLElement {
    ...
    constructor(t) {
        super(), this.version = "2.5.4", this.config = {
                markedUrl: "https://cdn.mcalec.dev/web/js/marked.min.js",
                prismUrl: [
                    ["https://cdn.mcalec.dev/web/js/prism/prism.min.js", "data-manual"], "https://cdn.mcalec.dev/web/js/prism/prism-autoloader.min.js"
                ],
                cssUrls: ["https://cdn.mcalec.dev/web/css/github-markdown/dark.min.css", "https://cdn.mcalec.dev/web/css/github-markdown/light.min.css", "https://cdn.mcalec.dev/web/css/prism/prism.min.css"],
    ...
    observeChanges() {
        this.querySelectorAll('template,script[type="text/markdown"]')
            .forEach((t => {
    ...
    loadScript(t) {
        return Promise.all(this.arrify(t)
            .map((t => {
    ...
    highlight(t) {
        return new Promise((e => {
            t.querySelectorAll('pre>code:not([class*="language-"])')
                .forEach((t => {
    ...
    async stampStyles(t) {
        ...
        if (s.getAttribute("data-hash") !== e) {
            ...
            return s.innerHTML = "", s.append(...r), await Promise.all(i.map((t => this.onload(t))))
                .catch((t => {
